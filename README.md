...
> **Note:** Actual PDF file contents and extracted sensitive string values are **never stored** in the database.
...
```bash
cd C:\Users\HP\.gemini\antigravity\scratch\securedoc-ai
```
...
Create or edit your `.env` file with your MySQL server credentials:
```env
DB_HOST=localhost
DB_USER=root
DB_PASSWORD=your_mysql_password
DB_NAME=securedoc_db
DB_PORT=3306
SECRET_KEY=securedoc_ai_super_secret_key_2026
TEMP_DIR=./temp_files
```
